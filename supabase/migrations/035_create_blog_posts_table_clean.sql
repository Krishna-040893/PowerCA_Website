-- Drop the table completely if it exists (this removes all constraints too)
...
CREATE INDEX idx_blog_posts_breaking ON public.blog_posts(is_breaking, published_at DESC);

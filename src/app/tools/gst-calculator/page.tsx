...
//   title: 'GST Calculator India - Calculate GST Online Free | Power CA',
...
Generated by Power CA GST Calculator
https://powerca.in/tools/gst-calculator`
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pb-12">
      <PageHero title="GST Calculator for India" description="Calculate GST, CGST, SGST, and IGST instantly. Free online tool for CAs and businesses." />

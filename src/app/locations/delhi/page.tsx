  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        {/* Hero Section */}
        <PageHero
          title={<>Professional CA Software for <span className="text-blue-600">Delhi NCR</span></>}
          description={<>Designed for Chartered Accountants in Delhi, Gurgaon, and Noida. Complete practice management made simple</>}
        >

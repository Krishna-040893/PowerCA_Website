  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        {/* Hero Section */}
        <PageHero
          title={<>Smart CA Software for <span className="text-blue-600">Pune's</span> Growing Economy</>}
          description={<>Designed for Chartered Accountants in Pune's IT and manufacturing hubs. Complete practice management with Maharashtra compliance</>}
        >

        ...
        <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12 space-y-8">
          ...
          <Accordion type="single" collapsible defaultValue="agreement" className="space-y-4">
            ...
            <AccordionItem value="agreement" className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
              <AccordionTrigger className="px-5 sm:px-6 py-4 sm:py-5 hover:no-underline hover:bg-gray-50 transition-colors [&[data-state=open]]:bg-blue-50">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center">
                    <FileText className="h-4 w-4 sm:h-5 sm:w-5" />
                  </div>
                  <div className="text-left">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">Software Subscription & License Agreement</p>
              ...
              <AccordionContent className="px-5 sm:px-6 pb-6">
                <div className="prose prose-sm prose-gray max-w-none pt-4 border-t border-gray-100 max-h-[500px] overflow-y-auto pr-2 scrollbar-thin">
                  ...
                  <p className="text-gray-600 leading-relaxed mt-2">The license is:</p>
                  <BulletList items={[
                  ...
                  <p className="text-gray-600 leading-relaxed">The Subscriber shall not:</p>
                  <LetterList items={[
            ...
            <AccordionItem value="acceptable-use" className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
              <AccordionTrigger className="px-5 sm:px-6 py-4 sm:py-5 hover:no-underline hover:bg-gray-50 transition-colors [&[data-state=open]]:bg-emerald-50">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center">
                    <Shield className="h-4 w-4 sm:h-5 sm:w-5" />
                  </div>
                  <div className="text-left">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">Acceptable Use & Professional Compliance Policy</p>
              ...
              <AccordionContent className="px-5 sm:px-6 pb-6">
                <div className="prose prose-sm prose-gray max-w-none pt-4 border-t border-gray-100">
                  ...
                  <p className="text-gray-600 leading-relaxed">The Software may be used solely for:</p>
                  <BulletList items={[
                  ...
                  <p className="text-gray-600 leading-relaxed">The Subscriber and Authorized Users shall not:</p>
                  ...
                  <p className="text-gray-600 leading-relaxed">The Subscriber remains fully responsible for:</p>
                  <BulletList items={[
                    'Accuracy of filings',
                  ...
                  <p className="text-gray-600 leading-relaxed">Subscribers shall not:</p>
                  <BulletList items={[
            ...
            <AccordionItem value="data-processing" className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
              <AccordionTrigger className="px-5 sm:px-6 py-4 sm:py-5 hover:no-underline hover:bg-gray-50 transition-colors [&[data-state=open]]:bg-purple-50">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center">
                    <Lock className="h-4 w-4 sm:h-5 sm:w-5" />
                  </div>
                  <div className="text-left">
                    <p className="text-sm sm:text-base font-semibold text-gray-900">Data Processing & Confidentiality Addendum</p>
              ...
              <AccordionContent className="px-5 sm:px-6 pb-6">
                <div className="prose prose-sm prose-gray max-w-none pt-4 border-t border-gray-100">
                  ...
                  <p className="text-gray-600 leading-relaxed">Confidential Information includes:</p>
                  <BulletList items={[
                  ...
                  <p className="text-gray-600 leading-relaxed mt-3">Excludes information that is:</p>
                  <BulletList items={[
                    'Publicly known',
                  ...
                  <p className="text-gray-600 leading-relaxed">Each party shall:</p>
                  <BulletList items={[
...
function SectionHeading({ number, title }: { number: string; title: string }) {
  return (
    <h3 className="flex items-center gap-2 text-base font-semibold text-gray-900 mt-6 mb-2">
...
function BulletList({ items }: { items: string[] }) {
  return (
    <ul className="mt-2 space-y-1.5 pl-5">
      {items.map((item, i) => (
        <li key={i} className="text-gray-600 leading-relaxed list-disc marker:text-gray-300">{item}</li>
      ))}
    </ul>
  )
}
...
function LetterList({ items }: { items: string[] }) {
  return (
    <ol className="mt-2 space-y-1.5 pl-5 list-[lower-alpha]">
      {items.map((item, i) => (
        <li key={i} className="text-gray-600 leading-relaxed marker:text-gray-400 marker:font-medium">{item}</li>
      ))}
    </ol>
  )
}
...
function NumberedSubList({ items }: { items: string[] }) {
  return (
    <ol className="mt-2 space-y-1.5 pl-5">
      {items.map((item, i) => (
        <li key={i} className="text-gray-600 leading-relaxed list-decimal marker:text-gray-400 marker:font-medium">{item}</li>
      ))}
    </ol>
  )
}

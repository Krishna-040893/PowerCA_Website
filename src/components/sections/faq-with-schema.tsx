...
export const powerCAFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'PowerCA offers flexible pricing plans to suit your needs: 1) Annual License at ₹1,800/user/year, 2) 2 Year Pack at ₹3,000/user (one-time payment), and 3) Enterprise/Large Practitioner with custom pricing for 20+ users. All plans include installation, demo, and ongoing support. Contact us to learn more about how PowerCA can fit your practice needs.'
  },
  {
